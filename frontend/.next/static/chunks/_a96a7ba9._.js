        ...
        "ConversationsPage.useEffect": ()=>{
            ...
            const handleNewMessage = {
                "ConversationsPage.useEffect.handleNewMessage": (data)=>{
                    ...
                    if ((selectedConversation === null || selectedConversation === void 0 ? void 0 : selectedConversation.id) === data.conversationId) {
                        setMessages({
                            "ConversationsPage.useEffect.handleNewMessage": (prev)=>[
                                    ...prev,
                                    {
                                        id: data.messageId,
            ...
            socket.on('message_status_update', {
                "ConversationsPage.useEffect": (data)=>{
                    setMessages({
                        "ConversationsPage.useEffect": (prev)=>prev.map({
...
_s(ConversationsPage, "Q0N+2Ey2WNvIlgZqcrCccTKdI6Y=", false, function() {
    return [
...
//# sourceMappingURL=_a96a7ba9._.js.map